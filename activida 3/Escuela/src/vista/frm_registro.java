...
public class frm_registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_principal.setBackground(new java.awt.Color(0, 204, 204));
        panel_principal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        panel_principal.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        panel_encabezado.setBackground(new java.awt.Color(0, 204, 204));
        ...
        lbl_titulo.setText("REGISTRO DOCENTE");
        panel_encabezado.add(lbl_titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 260, 48));

        panel_cerrar.setBackground(new java.awt.Color(0, 204, 204));

        lbl_cerrar.setBackground(new java.awt.Color(204, 204, 204));
        lbl_cerrar.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        panel_cerrarLayout.setHorizontalGroup(
            ...
            .addGroup(panel_cerrarLayout.createSequentialGroup()
                .addComponent(lbl_cerrar, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panel_encabezado.add(panel_cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 0, -1, -1));

        panel_principal.add(panel_encabezado, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, -1));
        ...
        panel_principal.add(lbl_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 100, 30));
        ...
        panel_principal.add(lbl_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 100, 30));

        lbl_nacimiento.setBackground(new java.awt.Color(255, 255, 252));
        lbl_nacimiento.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_nacimiento.setForeground(new java.awt.Color(255, 255, 255));
        lbl_nacimiento.setText("FECHA NACIMIENTO");
        panel_principal.add(lbl_nacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 190, 30));

        lbl_salario.setBackground(new java.awt.Color(255, 255, 252));
        lbl_salario.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_salario.setForeground(new java.awt.Color(255, 255, 255));
        lbl_salario.setText("SALARIO");
        panel_principal.add(lbl_salario, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, 140, 30));
        ...
        panel_principal.add(lbl_codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, 180, 30));

        lbl_labores.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_labores.setForeground(new java.awt.Color(255, 255, 255));
        lbl_labores.setText("FECHA INGRESO DE LABORES");
        panel_principal.add(lbl_labores, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 220, 260, 30));
        ...
        panel_principal.add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 70, 170, 20));
        ...
        panel_principal.add(txt_nit, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 100, 20));
        ...
        panel_principal.add(txt_nombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 170, 20));
        ...
        panel_principal.add(txt_apellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 170, 20));
        ...
        panel_principal.add(txt_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, 300, 20));
        ...
        panel_principal.add(txt_nacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 170, 20));
        ...
        panel_principal.add(txt_codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 170, 20));
        ...
        panel_principal.add(txt_salario, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 190, 170, 20));
        ...
        panel_principal.add(txt_labores, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 230, 170, 20));
        ...
        panel_principal.add(btn_borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 300, 100, 40));

        btn_agregar.setBackground(new java.awt.Color(51, 153, 255));
        ...
        panel_principal.add(btn_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, 110, 40));
        ...
        panel_principal.add(btn_modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 300, 120, 40));

        table_datos.setBackground(new java.awt.Color(0, 255, 204));
        ...
        if (table_datos.getColumnModel().getColumnCount() > 0) {
            table_datos.getColumnModel().getColumn(0).setHeaderValue("ID");
            table_datos.getColumnModel().getColumn(1).setHeaderValue("Title 2");
            table_datos.getColumnModel().getColumn(2).setHeaderValue("Title 3");
            table_datos.getColumnModel().getColumn(3).setHeaderValue("Title 4");
            table_datos.getColumnModel().getColumn(4).setHeaderValue("Title 5");
            table_datos.getColumnModel().getColumn(5).setHeaderValue("Title 6");
            table_datos.getColumnModel().getColumn(6).setHeaderValue("Title 7");
            table_datos.getColumnModel().getColumn(7).setHeaderValue("Title 8");
            table_datos.getColumnModel().getColumn(8).setHeaderValue("Title 9");
            table_datos.getColumnModel().getColumn(9).setHeaderValue("Title 10");
            table_datos.getColumnModel().getColumn(10).setHeaderValue("Title 11");
        }

        panel_principal.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 830, 150));
        ...
        lbl_nit2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
